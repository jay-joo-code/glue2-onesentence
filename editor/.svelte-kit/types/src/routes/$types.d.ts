...
type LayoutRouteId = RouteId | "/" | "/chatrooms/[chatroomId]" | "/driver-dashboard" | "/error-test" | "/privacy-policy" | "/profile/my-reservations" | "/redirect" | "/search" | "/sentry-example" | "/terms-conditions" | null
type LayoutParams = RouteParams & { chatroomId?: string }
